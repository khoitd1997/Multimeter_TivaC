...
//!
//*****************************************************************************
#define NEXT_USB_DESCRIPTOR(ptr) (tDescriptorHeader *)(((uint8_t *)(ptr)) + *((uint8_t *)(ptr)))
...
extern uint32_t USBDescGetNum(tDescriptorHeader *psDesc, uint32_t ui32Size, uint32_t ui32Type);
...
extern tInterfaceDescriptor *USBDescGetInterface(tConfigDescriptor *psConfig,
                                                 uint32_t           ui32Index,
                                                 uint32_t           ui32AltCfg);
extern tEndpointDescriptor * USBDescGetInterfaceEndpoint(tInterfaceDescriptor *psInterface,
                                                         uint32_t              ui32Index,
                                                         uint32_t              ui32Size);
...
//
//*****************************************************************************
typedef uint32_t (*tUSBCallback)(void *   pvCBData,
                                 uint32_t ui32Event,
...
//
//*****************************************************************************
typedef uint32_t (*tUSBPacketTransfer)(void *   pvHandle,
                                       uint8_t *pi8Data,
                                       uint32_t ui32Length,
                                       bool     bLast);
...
extern void              USBBufferZeroLengthPacketInsert(const tUSBBuffer *psBuffer, bool bSendZLP);
...
extern uint32_t          USBBufferWrite(const tUSBBuffer *psBuffer,
                                        const uint8_t *   pui8Data,
                                        uint32_t          ui32Length);
extern void              USBBufferDataWritten(const tUSBBuffer *psBuffer, uint32_t ui32Length);
extern void              USBBufferDataRemoved(const tUSBBuffer *psBuffer, uint32_t ui32Length);
extern void              USBBufferFlush(const tUSBBuffer *psBuffer);
extern uint32_t USBBufferRead(const tUSBBuffer *psBuffer, uint8_t *pui8Data, uint32_t ui32Length);
...
extern uint32_t USBBufferEventCallback(void *   pvCBData,
                                       uint32_t ui32Event,
...
extern void USBRingBufRead(tUSBRingBufObject *psUSBRingBuf, uint8_t *pui8Data, uint32_t ui32Length);
extern void USBRingBufWriteOne(tUSBRingBufObject *psUSBRingBuf, uint8_t ui8Data);
extern void USBRingBufWrite(tUSBRingBufObject *psUSBRingBuf,
                            const uint8_t *    pui8Data,
                            uint32_t           ui32Length);
extern void USBRingBufAdvanceWrite(tUSBRingBufObject *psUSBRingBuf, uint32_t ui32NumBytes);
extern void USBRingBufAdvanceRead(tUSBRingBufObject *psUSBRingBuf, uint32_t ui32NumBytes);
extern void USBRingBufInit(tUSBRingBufObject *psUSBRingBuf, uint8_t *pui8Buf, uint32_t ui32Size);
...
extern void USBOTGModeInit(uint32_t ui32Index,
                           uint32_t ui32PollRate,
                           void *   pHostData,
                           uint32_t ui32HostDataSize);
extern void USBOTGModeTerm(uint32_t ui32Index);
extern void USB0OTGModeIntHandler(void);
extern bool USBOTGFeatureSet(uint32_t ui32Index, uint32_t ui32Feature, void *pvFeature);
