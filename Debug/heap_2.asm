...
;* Date/Time created: Thu Sep 20 01:12:47 2018                                *
;******************************************************************************
...
ucHeap:	.usect	".bss:ucHeap",10000,1
...
xFreeBytesRemaining:
	.bits	9992,32			; xFreeBytesRemaining @ 0
...
;	/opt/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.3.LTS/bin/armacpia -@/tmp/TI0YZaPPQ9s 
...
$C$DW$T$115	.dwtag  DW_TAG_array_type
	...
	.dwattr $C$DW$T$115, DW_AT_byte_size(0x2710)
$C$DW$85	.dwtag  DW_TAG_subrange_type
	.dwattr $C$DW$85, DW_AT_upper_bound(0x270f)
