...
;* Date/Time created: Thu Sep 20 01:12:51 2018                                *
;******************************************************************************
	.compiler_opts --abi=eabi --arm_vmrs_si_workaround=off --code_state=16 --diag_wrap=off --embedded_constants=on --endian=little --float_support=FPv4SPD16 --hll_source=on --object_format=elf --silicon_version=7M4 --symdebug:dwarf --symdebug:dwarf_version=3 --unaligned_access=on 
	.thumb

$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../multimeter/freeRTOS_hook.c")
...
;	/opt/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.3.LTS/bin/armacpia -@/tmp/TI10WFngn03 
...
$C$DW$4	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$4, DW_AT_TI_begin_file("../multimeter/freeRTOS_hook.c")
	.dwattr $C$DW$4, DW_AT_TI_begin_line(0x14)
	.dwattr $C$DW$4, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$4, DW_AT_decl_file("../multimeter/freeRTOS_hook.c")
	.dwattr $C$DW$4, DW_AT_decl_line(0x14)
	.dwattr $C$DW$4, DW_AT_decl_column(0x06)
	.dwattr $C$DW$4, DW_AT_TI_max_frame_size(0x10)
	.dwpsn	file "../multimeter/freeRTOS_hook.c",line 20,column 75,is_stmt,address vApplicationStackOverflowHook,isa 1
...
$C$DW$8	.dwtag  DW_TAG_variable
	...
	.dwpsn	file "../multimeter/freeRTOS_hook.c",line 24,column 3,is_stmt,isa 1
...
;* --------------------------------------------------------------------------*
||$C$L1||:    
	.dwpsn	file "../multimeter/freeRTOS_hook.c",line 25,column 13,is_stmt,isa 1
        B         ||$C$L1||             ; [DPU_V7M3_PIPE] |25| 
        ; BRANCH OCCURS {||$C$L1||}      ; [] |25| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$4, DW_AT_TI_end_file("../multimeter/freeRTOS_hook.c")
