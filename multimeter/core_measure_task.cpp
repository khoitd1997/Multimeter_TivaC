...
// static const uint32_t CORE_TASK_STACK = 800;  // BE CAREFUL WITH MAX, can be smaller when not
// debug static const uint32_t CORE_TASK_PRIORITY = 5; static const uint32_t CORE_TASK_TIMEOUT  =
// pdMS_TO_TICKS(50);
